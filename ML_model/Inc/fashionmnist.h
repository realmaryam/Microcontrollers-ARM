...
#ifndef AI_FASHIONMNIST_H
#define AI_FASHIONMNIST_H
#pragma once

#include "fashionmnist_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_FASHIONMNIST_MODEL_NAME          "fashionmnist"
#define AI_FASHIONMNIST_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_FASHIONMNIST_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_FASHIONMNIST_IN_NUM        (1)
#define AI_FASHIONMNIST_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 784, 1, NULL), \
}
#define AI_FASHIONMNIST_IN_SIZE { \
  AI_FASHIONMNIST_IN_1_SIZE, \
}
#define AI_FASHIONMNIST_IN_SIZE_BYTES { \
  AI_FASHIONMNIST_IN_1_SIZE_BYTES, \
}
#define AI_FASHIONMNIST_IN_1_CHANNEL     (784)
#define AI_FASHIONMNIST_IN_1_SIZE        (784)
#define AI_FASHIONMNIST_IN_1_SIZE_BYTES  (AI_FASHIONMNIST_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_FASHIONMNIST_OUT_NUM       (1)
#define AI_FASHIONMNIST_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_FASHIONMNIST_OUT_SIZE { \
  AI_FASHIONMNIST_OUT_1_SIZE, \
}
#define AI_FASHIONMNIST_OUT_SIZE_BYTES { \
  AI_FASHIONMNIST_OUT_1_SIZE_BYTES, \
}
#define AI_FASHIONMNIST_OUT_1_CHANNEL     (10)
#define AI_FASHIONMNIST_OUT_1_SIZE        (10)
#define AI_FASHIONMNIST_OUT_1_SIZE_BYTES  (AI_FASHIONMNIST_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_FASHIONMNIST_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup fashionmnist
 ...
 * @ref ai_fashionmnist_create. Both the activations memory buffer 
 ...
 * using @ref ai_fashionmnist_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_FASHIONMNIST_*
 * defines into file @ref fashionmnist.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_fashionmnist_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_FASHIONMNIST_H */
